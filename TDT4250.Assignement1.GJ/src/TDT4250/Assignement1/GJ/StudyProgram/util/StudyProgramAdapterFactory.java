...
public class StudyProgramAdapterFactory extends AdapterFactoryImpl {
	...
	protected StudyProgramSwitch<Adapter> modelSwitch =
		new StudyProgramSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFieldofstudy(Fieldofstudy object) {
				return createFieldofstudyAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link TDT4250.Assignement1.GJ.StudyProgram.Course <em>Course</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link TDT4250.Assignement1.GJ.StudyProgram.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link TDT4250.Assignement1.GJ.StudyProgram.Year <em>Year</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link TDT4250.Assignement1.GJ.StudyProgram.Semester <em>Semester</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link TDT4250.Assignement1.GJ.StudyProgram.Studyprogram <em>Studyprogram</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link TDT4250.Assignement1.GJ.StudyProgram.Fieldofstudy <em>Fieldofstudy</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFieldofstudyAdapter() {
		return null;
	}
