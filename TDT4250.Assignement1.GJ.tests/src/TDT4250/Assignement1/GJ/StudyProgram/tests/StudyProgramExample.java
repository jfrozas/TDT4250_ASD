...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>StudyProgram</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class StudyProgramExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(StudyProgramPackage.eNS_URI, 
			 StudyProgramPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.studyprogram"));
				Course root = StudyProgramFactory.eINSTANCE.createCourse();
